...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>jmeter</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class JmeterExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(JmeterPackage.eNS_URI, 
			 JmeterPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.jmeter"));
				TestPlan root = JmeterFactory.eINSTANCE.createTestPlan();
